    ...
    for r in rounds:
        ...
        results.append(
            RoundListResponse(
                ...
                compare_to_round_id=r.compare_to_round_id,
                hidden_member_ids=r.hidden_member_ids,
...
async def get_round_detail(
    ...
    return RoundDetailResponse(
        ...
        compare_to_round_id=round_.compare_to_round_id,
        hidden_member_ids=round_.hidden_member_ids,
