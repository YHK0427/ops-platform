...
EVAL_QUESTIONS = [
    ...
    },
    {
        ...
        "audience_text": "발표자는 본인만의 관점과 해석이 드러난 차별화된 메시지를 전달했다",
    },
    # ── 디자인 ──
    {
        ...
        "order": 4,
        "label": "가독성",
        "self_text": "나는 슬라이드의 글자 크기와 배치를 청중의 시선을 고려해 읽기 쉽게 구성했다",
    ...
    },
    {
        ...
        "order": 6,
        "label": "창의성",
        "self_text": "나는 파워포인트의 다양한 기능과 디자인 요소를 발표의 분위기와 목적에 맞게 의도적으로 활용했다",
        "audience_text": "발표자는 파워포인트의 다양한 기능과 디자인 요소를 발표의 분위기와 목적에 맞게 의도적으로 활용했다",
    },
    # ── 스피치 ──
    {
