...
import { useGivePenalty } from "@/hooks";
...
const PRESETS: Preset[] = [
    ...
    { label: "기타 벌점 (1점)", score: 1, deposit: 0, desc: "" },
    { label: "기타 벌점 (2점)", score: 2, deposit: 0, desc: "" },
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            {PRESETS.map((p, idx) => (
                                ...
                                >
                                    ...
                                    {p.score !== 0 && (
                                        <div className="text-xs opacity-70 mt-0.5">-{p.score}점</div>
                                    )}
                                </button>
                            ))}
                        </div>
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <div className="col-span-3 relative">
                                ...
                                <Input
                                    type="number"
                                    value={deposit}
                                    onChange={(e) => setDeposit(Math.abs(Number(e.target.value)) || 0)}
                                    min={0}
                                    placeholder="0 (차감 없음)"
                                    className="pl-7"
                                />
